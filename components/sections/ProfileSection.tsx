        ...
        <>
          <Box gap={4} my={10}>
            <Box display="flex" flexDirection="column" justifyContent="center">
              ...
              <Link href={SITE_PROFILE_URL} target="_blank"><Button background="var(--blue1)" size="lg" minWidth="300px">
                {t('linkWebsiteButton')}
              </Button></Link>
              <Link href={'/link'} target="_blank"><Button size="lg" minWidth="300px" mt={2}>
